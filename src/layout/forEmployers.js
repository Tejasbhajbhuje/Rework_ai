  ...
  return (
    <div className="brands-section-container">
      ...
      <div className="brands-section-logos">
        <img height="26px" src='google.png'></img>
        <img height="26px" src='amazon.png'></img>
        <img height="26px" src='nokia.png'></img>
        <img height="26px" src='spotify.png'></img>
        <img height="26px" src='nokia.png'></img>
        <img height="26px" src='google.png'></img>
        <img height="26px" src='amazon.png'></img>
        </div>
    ...
    <div className="benefits-section-container">
      ...
      <div className="benefits-card-holder">
        <BenefitCard
          ...
          title2={"Cost Reduce"}
          description={
            "Zero overhead in the hiring process - promise! Source top quality candidates for some of the best companies"
          }
        ></BenefitCard>
        <BenefitCard
          img='ico2.svg'
        ...
        <BenefitCard
          ...
          title2={"Interview"}
          description={
            "Al models generate highly contextualized interviews for the candidates based on your Company profile, Job description and Candidate's CV."
          }
        ></BenefitCard>
        <BenefitCard
          img='ico4.svg'
...
const OperateInstructionsSection = () => {
  return (
    <div className="operate-section-container">
      <div className="operate-section-title">
      ...
      <div className="operate-section-card-holders">
        <div className="operate-section-card">
          <img
            width={"64px"}
            className="operate-section-card-img-top"
            src={upload}
          ></img>
          <div className="operate-section-card-content">
            <div className="operate-section-card-content-title">
              Upload Docuements
            </div>
            <div className="operate-section-card-content-desc">
        ...
        <div className="operate-section-card pink">
          <img
            width={"64px"}
            className="operate-section-card-img-bottom"
            src={signup}
          ></img>
          <div className="operate-section-card-content">
  ...
  return (
    <div className="price-section-container">
      <div className="price-section-title">
        <span>Choose Your Simple,</span> Transparent Pricing
      </div>
  ...
  return (
    <div className={`price-card-container ${dark ? "dark" : ""}`}>
      ...
      <div className={`price-card-top-section`}>
        <div
          className={`price-card-duration ${dark ? "dark-theme-fonts" : ""}`}
        >
          {duration}
        </div>
        <div className={`price-card-price ${dark ? "dark-theme-fonts" : ""}`}>
          {price}
        </div>
      </div>
      <div className={`price-card-benefits`}>
        <div className={`price-card-title ${dark ? "dark-theme-fonts" : ""}`}>
          {title}
        </div>
            ...
            points.map((element) => {
              return (
                <div className={`price-card-points`}>
                  ...
                  <div className={`${dark ? "dark-theme-fonts" : ""}`}>
                    {element.title}
                  </div>
                </div>
              );
      ...
      <button className={dark ? "price-card-btn-light" : "price-card-btn-dark"}>
        Get Started
      </button>
    </div>
  );
      ...
      <div className="download-section-content">
        <div className="download-section-content-typo">
          <div className="download-section-header">
            <span>Discover the Future of</span> Talent Assessment!
          </div>
          <div className="download-section-details">
    ...
    <div className="section-container grey-back">
      <div className="info-section-container">
        <div className="info-section-highlight">
          <span>How Rework AI has been a good</span> Hiring platform for
          Companies
        </div>
...
const Accordion = () => {
  ...
  return (
    <div className="accordion-container">
      ...
      {expanded ? (
        <div>
          Lorem ipsum dolor sit amet consectetur. Porta velit ultricies feugiat
          tortor odio. Scelerisque habitant quam pharetra adipiscing id ipsum et
          lectus malesuada.
        </div>
      ) : null}
    </div>
...
const RequestAuditSection = () => {
  return (
    <div className="request-audit-section-container">
      <div className="section-top-content-header1">
        Optimize Your Hiring Strategy with Rework's Exclusive Hiring Audit
      </div>
      <div className="request-audit-text">
        Discover the strengths and opportunities in your current hiring process.
        Our comprehensive Hiring Audit evaluates your strategy, identifies areas
        for improvement, and tailors a roadmap for success. Elevate your
        recruitment game with data-driven insights - because the right talent
